    ...
    <div class="pay-container">
      <div class="checkout-tit">
        ...
        <div class="paymark">
          ...
          <span class="fr"><em class="lead">应付金额：</em><em class="orange money">￥{{payInfo.totalFeel}}</em></span>
        </div>
      </div>
...
<script>
// 获取 DOM 的标签,再通过 HTML5 Canvas 绘制而成
import QRCode from 'qrcode'
  export default {
    ...
    mounted(){
      // 获取订单支付信息, 不能在mounted生命周期函数中用async, 改用写一个函数来
      this.getPayInfo()
    },
    methods: {
      // 获取支付信息
      ...
      open(){
          // 生成二维码,可以将字符串转化为二维码
          let result = QRCode.toDateURL('this.payInfo.codeUrl')
